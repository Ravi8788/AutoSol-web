      ...
      <section className="section" id="enquiry-form" style={{ background: "var(--deep)" }}>
        <div className="container contact-main-layout">
          ...
          <div className="contact-left">
            ...
            <div className="contact-info-card" style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <p style={{ color: "#4b607e", fontSize: "9px", fontWeight: 700, letterSpacing: ".14em", marginBottom: "0" }}>SOCIAL LINKS</p>
              <a
